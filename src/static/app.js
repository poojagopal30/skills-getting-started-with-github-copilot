document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
      ...
      // Clear loading message and rebuild the list from the fresh API response
              ...
              .map(
                (email) => `
                  <li class="participant-item">
                    ...
                    <button class="delete-participant" aria-label="Remove ${email} from ${name}" data-activity="${name}" data-email="${email}">
                      ✕
                    </button>
                  </li>
                `
